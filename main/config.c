...
{
    if      (strcmp("gitta",    str) == 0) { return CONFIG_MODEL_GITTA; }
    //else if (strcmp("standard", str) == 0) { return CONFIG_MODEL_STANDARD; }
...
{
    if      (strcmp("none",   str) == 0) { return CONFIG_DRIVER_NONE; }
    else if (strcmp("WS2801", str) == 0) { return CONFIG_DRIVER_WS2801; }
            ...
            if (pkTok->parent == 0)
            {
                ...
                if ( (pkNext->parent == ix) && (pkNext->type == JSMN_STRING) )
                {
                    ...
                    else if (strcmp("driver", key) == 0)
                    {
                        ...
                        if (configDriver == CONFIG_DRIVER_UNKNOWN)
                        {
                    ...
                    else if (strcmp("order", key) == 0)
                    {
                        ...
                        if (configOrder == CONFIG_ORDER_UNKNOWN)
                        {
                    ...
                    else if (strcmp("bright", key) == 0)
                    {
                        ...
                        if (configBright == CONFIG_BRIGHT_UNKNOWN)
                        {
                    ...
                    else if (strcmp("noise", key) == 0)
                    {
                        ...
                        if (configNoise == CONFIG_NOISE_UNKNOWN)
                        {
